...
def autoexit_command(debugger, command, result, internal_dict):
    ...
    out = None
    if 'fruitstrap_output_path' in internal_dict:
        out = open(internal_dict['fruitstrap_output_path'], 'w')

    err = None
    if 'fruitstrap_error_path' in internal_dict:
        err = open(internal_dict['fruitstrap_error_path'], 'w')

    detectDeadlockTimeout = 10 #{detect_deadlock_timeout}
